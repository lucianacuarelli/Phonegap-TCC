...
neshaug.BoardView.prototype.setCanvas = function (canvas) {
    ...
    this._canvas.ontouchmove = function (e) {
        ...
        that.onMouseMove(touch.pageX - offsetLeft, touch.pageY - offsetTop);
        e.preventDefault();
    };
    this._canvas.ontouchstart = function (e) {
    	var touch = event.targetTouches[0];
        that.onMouseDown(touch.pageX - offsetLeft, touch.pageY - offsetTop);
        e.preventDefault();
    };
    this._canvas.ontouchcancel = function (e) {
    	var touch = event.targetTouches[0];
        that.onMouseUp(touch.pageX, touch.pageY);
    };
};
